...
```
apps/irc/services/unrealircd/config/
...
#### Atheme Templates
```
apps/irc/services/atheme/config/
...
apps/irc/services/*/config/*.conf
!apps/irc/services/*/config/*.template
!apps/irc/services/*/config/modules.*.conf
!apps/irc/services/*/config/operclass.*.conf
```
...
docker run --rm -v $(pwd)/apps/irc/services/unrealircd/config:/config \
    unrealircd unrealircd -c /config/unrealircd.conf -t

# Test Atheme config
docker run --rm -v $(pwd)/apps/irc/services/atheme/config:/config \
...
git log --oneline apps/irc/services/*/config/*.template
```
...
find apps/irc/services -name "*.conf" -exec echo "Checking {}" \; \
...
# Restore from backup
cp backup/.env .env
cp backup/*.template apps/irc/services/*/config/
...
git add apps/irc/services/*/config/*.template
...
find apps/irc/services -name "*.template" -newer *.conf
...
git diff apps/irc/services/*/config/*.template
