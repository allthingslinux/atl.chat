...
| UnrealIRCd | `data/irc/logs/` | IRC server logs |
...
| Atheme | `data/atheme/logs/` | Atheme service logs |
| Prosody | `data/xmpp/data/` | XMPP user accounts, rosters, MUC history |
| Prosody | `data/xmpp/logs/` | XMPP server logs |
...
- **Logs** (`data/irc/logs/`, `data/atheme/logs/`, `data/xmpp/logs/`) — useful for auditing but can be regenerated.
